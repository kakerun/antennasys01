...
//--------AntennaID取得
$antid = get_Antenna_ID_Self();
//--------Class設定
//DB
$gdb = new GET_SET_DB;
$gdb->Excange_Folder_DB();
//設定値
$gdf = new SITE_EACH_DATA($gdb,$antid);
$gdf->Excange_Folder_DB();
$gdf->Excange_Folder_LOG();
$gdf->Excange_Folder_DAT();
//カテゴリー
$gct = new GET_CATEGORY($antid,$gdf->CATEGORY,$gdf->CATEGORY_RSS_MAX);
//HTML生成
$mht = new MAKE_HTML;
//時間パス関係
...
<script type="text/javascript" src="http://arheto.net/cgi-bin/lunalys/analyzer/tracker.js"></script>
<noscript><img src="http://arheto.net/cgi-bin/lunalys/analyzer/write.php?guid=ON&act=img" width="0" height="0" alt="tracker"></noscript>
</div>
...
//広告 MicroAD
/*if($ua_smartphone == true){
	echo '<div class="adfunnel_sp" data-adfunnel='."'".'{ "spotid":"05b211baa885b3dd", "seq":1, "immediate":"on" }'."'".'></div>
...
if($ua_smartphone == false){
	/*echo '<!-- admax -->
<script src="http://adm.shinobi.jp/s/ece1b705e9a92b8a435e7edbe5928179"></script>
<!-- admax -->';*/
}
?>
...
<div id="intro_ad">
課金をポイントで賄うなら以下のサイトがオススメ。換金確認したサイトだけ載せてます。<br />
<a href="http://moppy.jp/top.php?DYqre174" target="_blank">モッピー</a>
<a href="http://www.gendama.jp/invite/?frid=5204152&ref=90000-blog" target="_blank">げん玉</a>
<a href="http://www.pointtown.com/ptu/regist/friendship.do?guid=ON&found=100166&intrid=Pacexzh6ELy8M" target="_blank">ポイントタウン</a>
<a href="https://m.hapitas.jp/register?i=20486078&route=text" target="_blank">ハピタス</a>
</div>
...
/*if($ua_smartphone == false){
	...
	//about
	$mht->dat_view($gdf->FOLDER_DAT.$gdf->DAT_ABOUT);

	echo '</ul>';

	echo '<br />';
	echo 'Twitterフォロー';
	echo '<a href="https://twitter.com/twobekoantenna" class="twitter-follow-button" data-show-count="false" data-lang="ja">@twobekoantennaさんをフォロー</a>
	<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src="//platform.twitter.com/widgets.js";fjs.parentNode.insertBefore(js,fjs);}}(document,"script","twitter-wjs");</script>';

	echo '<a href="?c=info"><span>このサイトについて</span></a>
	<a href="?c=list"><span>掲載サイト一覧</span></a>
	</div>';
	...
	echo '<div id="pr">';
	echo '<!-- admax -->
<script src="http://adm.shinobi.jp/s/da6f3dbb5c817085ae9c1a99d90f7b4f"></script>
<!-- admax -->';
	echo "</div>\n";
}*/
?>
...
if($ua_smartphone == false){
	...
	//echo '<script type="text/javascript" src="./acc/racc.php"></script>'."\n";
	...
	print "<ul>\n";
	$mht->dat_view($gdf->FOLDER_DAT.$gdf->DAT_RANKING);
	print "</ul>\n";
	echo "</div>\n";
}*/
?>
...
//カウンター
//$count_array = counter();
//print "<span>総合:".$count_array[0]."</span><br />\n";
//print "<span>今日:".$count_array[1]."</span><br />\n";
//print "<span>昨日:".$count_array[2]."</span><br />\n";
...
<li><a href="./rsslog.php">RSS配信ログ</a></li>
<li><a href="./sitemap.xml">サイトマップ(.xml)</a></li>-->
</ul>
</div>
<div class="copyright">
copyright (C) 2015 <?php print $gdf->SITE_TITLE;?> all rights reserved
</div>
</div>
